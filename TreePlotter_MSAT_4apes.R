...
# Top-level folders
# ----------------------------
base_dir <- "/home/rohan/PLM-Phylo/Results/Trees/MSAT_Trees/OMAM20_4apesAligned"
...
# ----------------------------
HUMAN <- "Homo_sapiens"
EXPECTED_SISTER <- "Pan_troglodytes"
OTHER_SPECIES <- c("Gorilla_gorilla_gorilla", "Pongo_abelii")
